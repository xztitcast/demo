...
t.agreement = {}
t.agreement.phone = '客服电话'
t.agreement.onlinetime = '人工客服在线时间'
t.agreement.oasuncodepic = '公众号太阳码'
t.agreement.citylimitlist = '区域限制'
t.agreement.aboutpf = '平台简介'
t.agreement.csprotool = '用户服务协议'
t.agreement.enterprotocl = '商户入驻协议'
t.agreement.privacyprotocol = '个人隐私协议'
t.agreement.merchantPrivacyProtocol = '商户隐私协议'
t.agreement.memberprotocol = '会员服务协议'
t.agreement.psbcelectronicprotocol = '中国邮政储蓄银行电子账户服务协议'
t.agreement.authProtocl = '中国邮政储蓄银行YOU商街授权协议'
t.agreement.psbcPrivacyProtocol = '中国邮政储蓄银行开户隐私协议'

t.appnotice = {}
t.appnotice.title = '公告标题'
t.appnotice.classification = '公告类型'
t.appnotice.status = '是否有效'
t.appnotice.status0 = '有效'
t.appnotice.status1 = '无效'
t.appnotice.content = '公告内容'
t.appnotice.shareTitle = '分享主题'
t.appnotice.shareTitleLimit = '最多16字符'
t.appnotice.shareContent = '分享内容'
t.appnotice.shareContentLimit = '最多50字符'
t.appnotice.sorted = '排序'
t.appnotice.type = '公告作用域'
t.appnotice.jumplink = '跳转链接'
t.appnotice.created = '发布时间'
